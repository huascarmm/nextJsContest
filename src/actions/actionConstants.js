...
export const MUNICIPALITY_DATA = 'MUNICIPALITY_DATA';
export const GET_FEATURES = 'GET_FEATURES';
export const GET_DEPARTMENTS = 'GET_DEPARTMENTS';
export const SET_DEPARTMENTS = 'SET_DEPARTMENTS';
export const SET_FEATURES = 'SET_FEATURES';
export const GET_LAST_LAWS = 'GET_LAST_LAWS';
export const SET_LAST_LAWS = 'SET_LAST_LAWS';

// posts
export const GET_POSTS = 'GET_POSTS';
export const SET_POSTS = 'SET_POSTS';
export const GET_POSTS_SUBCATEGORIES = 'GET_POSTS_SUBCATEGORIES';
export const SET_POSTS_SUBCATEGORIES = 'SET_POSTS_SUBCATEGORIES';
export const GET_POST = ' GET_POST';
export const SET_POST = 'SET_POST';

// gazette
export const SET_GAZETTE_POSTS = 'SET_GAZETTE_POSTS';
export const GET_GAZETTE_POST = ' GET_GAZETTE_POST';
export const SET_GAZETTE_POST = 'SET_GAZETTE_POST';
